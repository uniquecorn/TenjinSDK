...
public class IosTenjin : BaseTenjin
{
    ...
    private static TenjinStatic.DeferredDeeplinkDelegate registeredDeferredDeeplinkDelegate;
    private static TenjinStatic.AttributionInfoDelegate registeredAttributionInfoDelegate;
    ...
    public override void RequestTrackingAuthorizationWithCompletionHandler(Action<int> trackingAuthorizationCallback)
    {
        ...
        TenjinStatic.authorizationStatusDelegate = trackingAuthorizationCallback;
    ...
    private void SetTrackingAuthorizationStatus(string status)
    {
        ...
        TenjinStatic.authorizationStatusDelegate(Int16.Parse(status));
    }
