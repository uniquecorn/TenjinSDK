...
public class AndroidTenjin : BaseTenjin
{
	...
	public override void GetDeeplink(TenjinStatic.DeferredDeeplinkDelegate deferredDeeplinkDelegate) {
	...
	private class DeferredDeeplinkListener : AndroidJavaProxy {
		private TenjinStatic.DeferredDeeplinkDelegate callback;

		public DeferredDeeplinkListener(TenjinStatic.DeferredDeeplinkDelegate deferredDeeplinkCallback) : base("com.tenjin.android.Callback") {
	...
	public override void GetAttributionInfo(TenjinStatic.AttributionInfoDelegate attributionInfoDelegate)
	{
	...
	{
		private TenjinStatic.AttributionInfoDelegate callback;

		public AttributionInfoListener(TenjinStatic.AttributionInfoDelegate getAttributionInfoCallback) : base("com.tenjin.android.AttributionInfoCallback")
		{
