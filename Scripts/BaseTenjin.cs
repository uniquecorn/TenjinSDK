...
public abstract class BaseTenjin : MonoBehaviour
{
    ...
    public abstract void GetDeeplink(TenjinStatic.DeferredDeeplinkDelegate deferredDeeplinkDelegate);
    public abstract void GetAttributionInfo(TenjinStatic.AttributionInfoDelegate attributionInfoDelegate);
